...
py neural_style.py --video --video_input_dir "video_input/sky1/image1_LR_crop" --style_imgs_dir "styles" --style_imgs "kandinsky.jpg" --end_frame "71" --max_size "1000" --verbose
python3 neural_style.py --video --video_input_dir "video_input/Video1_LR" --style_imgs_dir "styles" --style_imgs "kandinsky.jpg" --end_frame "71" --max_size "1000" --verbose